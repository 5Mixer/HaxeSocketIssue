...
::String Host_obj::localhost(){
            	HX_STACK_FRAME("sys.net.Host","localhost",0x3fc4b19f,"sys.net.Host.localhost","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Host.hx",47,0xf180fedc)
HXLINE(  47)		return _hx_std_host_local();
            	}
